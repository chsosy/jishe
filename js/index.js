...
(function () {
    ...
    $("#row1").hover(function () {
        $(this).text();
        myechart.setOption(option_pie_all);
    });
    $("#row2").hover(function () {
        $(this).text();
        myechart.setOption(option_pie_one);
    });
    $("#row3").hover(function () {
        $(this).text();
        myechart.setOption(option_pie_two);
    });
    $("#row4").hover(function () {
        $(this).text();
        myechart.setOption(option_pie_three);
    });
    $("#row5").hover(function () {
        $(this).text();
        myechart.setOption(option_pie_one);
...
(function () {
    ...
    option_bar_all = {
        ...
        xAxis: [{
            ...
            type: 'category',
            // 使用 data 中的数据设为刻度文字
            data: ['金融中心', '哈林区', '下东城', '下西城', '', '', '......', '', '西班牙哈林区', '肉品市场区', '西村', '戏院区', '东村'],
            // 刻度设置
            axisTick: {
                // true意思：图形在刻度中间
                // false意思：图形在刻度之间
    ...
    option_bar_one = {
        ...
        xAxis: [{
            ...
            type: 'category',
            // 使用 data 中的数据设为刻度文字
            data: ['金融中心', '哈林区', '下东城', '下西城', '', '', '......', '', '哈林区', '肉品市场区', '西村', '戏院区', '东村'],
            // 刻度设置
            axisTick: {
                // true意思：图形在刻度中间
                // false意思：图形在刻度之间
        ...
        series: [

            {
                ...
                barWidth: '60%',
                // 数据
                data: [2300, 1600, 1500, 1460, 1300, item, item, item, 800, 650, 500, 380, 140]
            }
        ]
    };
    option_bar_two = {
        ...
        series: [

            {
                ...
                barWidth: '60%',
                // 数据
                data: [3300, 2400, 1800, 1460, 1100, item, item, item, 990, 850, 700, 580, 340]
            }
        ]
    };
    option_bar_three = {
        ...
        series: [

            {
                ...
                barWidth: '60%',
                // 数据
                data: [2900, 2200, 2000, 1760, 1600, item, item, item, 900, 650, 600, 580, 340]
            }
        ]
    };
    var myechart = echarts.init($('.users .bar')[0]);
    myechart.setOption(option_bar_all);
    $("#row1").hover(function () {
        $(this).text();
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('11230')
        income_add.html('233')
        myechart.setOption(option_bar_all);
    });
    $("#row2").hover(function () {
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('9040')
        income_add.html('-2323')
        $(this).text();
        myechart.setOption(option_bar_one);
    });
    $("#row3").hover(function () {
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('11000')
        income_add.html('233')
        $(this).text();
        myechart.setOption(option_bar_two);
    });
    $("#row4").hover(function () {
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('10992')
        income_add.html('349')
        $(this).text();
        myechart.setOption(option_bar_three);
    });
    $("#row5").hover(function () {
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('11400')
        income_add.html('245')
        $(this).text();
        myechart.setOption(option_bar_one);
    });
    $("#row6").hover(function () {
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('14000')
        income_add.html('2710')
        $(this).text();
        myechart.setOption(option_bar_one);
    });
    $("#row7").hover(function () {
        ...
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('13549')
        income_add.html('1260')
        myechart.setOption(option_bar_two);
    });
    $("#row8").hover(function () {
        var income_all = $('#income_all');
        var income_add = $('#income_add');
        income_all.html('9807')
        income_add.html('-890')
        $(this).text();
        myechart.setOption(option_bar_three);
    });
